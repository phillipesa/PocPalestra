...
namespace PocPalestra.Domain.Palestras
{
    public class Endereco : Entity<Endereco>
    {
        ...
        public virtual Palestra Palestra { get; private set; }
        #endregion

        public Endereco(Guid id, string logradouro, string numero, string complemento, string bairro, string cep, string cidade, string estado, Guid? palestraId)
        {
            Id = id;
